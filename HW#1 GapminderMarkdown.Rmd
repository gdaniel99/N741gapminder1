---
title: 'HW #1: Gapminder Example Report'
author: "Gaea Daniel"
...
#To get mean life expectancy rounded to two decimal places
round(mean(gapminder$lifeExp), digits=2)
#To get standard deviation of life expectancy rounded to two decimal places
round(sd(gapminder$lifeExp), digits=2)
#To get median life expectancy rounded to two decimal places
round(median(gapminder$lifeExp), digits=2)
#To get sample size of life expectancy
...
The sample size of life expectancy is `r length(gapminder$lifeExp)` years.
...
```{r}
#To get median life expectancy by continent
aggregate(lifeExp ~ continent, gapminder, median)
#To get mean life expectancy by continent
aggregate(lifeExp ~ continent, gapminder, mean)
#To get standard deviation of life expectancy by continent
...
library(ggplot2)
#To plot life expectancy by continent
ggplot(gapminder, aes(x = continent, y = lifeExp)) +
  geom_boxplot(outlier.colour = "hotpink") +
  geom_jitter(position = position_jitter(width = 0.1, height = 0), alpha = 1/4)
#To plot GDP per capita by continent
